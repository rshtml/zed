...
pub const HTML_ID: &str = "vscode-html-language-server";
...
impl HtmlExtension {
    ...
    pub fn html_language_server_command(
        &mut self,
    ...
    pub fn html_language_server_workspace_configuration(
        &mut self,
    ...
    pub fn html_language_server_initialization_options(
        &mut self,
